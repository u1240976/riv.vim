...
\},
\{'name': 'RivCreateLinkInline' , 'act': 'call riv#create#wrap_inline2("`","`_",%M)',
    \'note': 'Create inline Link based on current word',
    \'menu': 'Insert.LinkInline',
    \'type': 'mod', 'mode': 'ni', 'maps': ['co'], 'keys': [],
\},
